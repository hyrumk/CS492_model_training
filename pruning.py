...
def main():
    ...
    model_filename = "resnet18_dermnet.pt"
    model_filename_prefix = "pruned_model"
    pruned_model_filename = "resnet18_pruned.pt"
    model_filepath = os.path.join(model_dir, model_filename)
    ...
    model.fc = nn.Sequential(nn.Linear(512, 256),
                             ...
                             nn.Linear(256, 23),
                             nn.LogSoftmax(dim=1))
    model.load_state_dict(torch.load('best_resnet18_1.pth'))
    ...
    # pruned_model.load_state_dict(torch.load('saved_model/pruned_model_good.pt'))
